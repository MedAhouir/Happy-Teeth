...
const About = () => {
  return (
    <section className='py-8 px-6 font-mulish text-lg'>
        <div className='flex flex-col gap-2 lg:flex-row items-center justify-between'> 
            <div className='flex flex-col gap-4'>
                <h1 className='font-semibold font-mulish text-6xl lg:text-7xl'>About</h1>
                <div className='flex flex-col gap-7 lg:w-[600px] rounded-3xl py-10 px-8 bg-gray-100'> 
                ...
                <div className='flex flex-col gap-5 lg:flex-row justify-between'>
                    <div className='w-full lg:w-[280px] h-[200px] flex relative flex-col justify-between p-5 bg-gray-100 rounded-3xl'>
